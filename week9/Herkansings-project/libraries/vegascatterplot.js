export class VegaScatterplot {
    ...
    // "BestDeadliftKg", "Miles_per_Gallon", 600, 400, data array
    ...
    async loadConfig() {
        ...
        config.axes[0].title = this.settings.xLabel  //"BestDeadliftKg"
    ...
    /*[
        { "mpg": 5, "BestDeadliftKg": 5 },
        { "mpg": 30, "BestDeadliftKg": 30 }
    ]
    */
